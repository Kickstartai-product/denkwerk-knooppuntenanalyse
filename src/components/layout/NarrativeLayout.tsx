        ...
        <Dialog open={isLogoDialogOpen} onOpenChange={setIsLogoDialogOpen}>
            <DialogContent className="w-[95vw] sm:w-[90vw] max-w-2xl bg-white/95 backdrop-blur-sm p-0">
                ...
                <p className="text-gray-700 leading-relaxed text-left">
                    Dit analyse-instrument is ontwikkeld door <a href="https://denkwerk.online/" target="_blank" rel="noopener noreferrer" className="text-[rgb(0,153,168)] hover:underline">DenkWerk</a> in samenwerking met <a href="https://kickstart.ai/" target="_blank" rel="noopener noreferrer" className="text-[rgb(0,153,168)] hover:underline">KickstartAI</a> als onderdeel van het DenkWerk rapport 'Weerbaarheid by Design'.
                </p>
                <p className="text-gray-700 leading-relaxed text-left">
